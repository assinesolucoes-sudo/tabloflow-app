...
**Versão:** v2 · 23/04/2026 · estendida em P-V2 retroativo (D-167) com 3 termos novos da Família A.
**Escopo v2:** Família A (V2 retroativo + V1 + V11) + base transversal universal + extensões P-V2.
**Mudanças v1 → v2:**
...
**Expansão futura:** cada P-VN estende com termos visão-específicos em sua Seção 2. Termos comuns a 2+ visões são consolidados na próxima ALINHA.
...
## 4 · Bloco 3 · Classificações estruturais (V2 · replicável em V1/V11)
...
Análogos em V1/V11 (match determinístico · aderência contextual) ganham entradas próprias em P-V1/P-V11 · consome este padrão como modelo.
...
- **v2 · 23/04/2026 · este arquivo** · P-V2 retroativo (D-167) · 8 blocos · estende v1 com 3 termos consolidados da Família A:
...
- **v3 · 25/04/2026 · este arquivo** · ALINHA-Descoberta-Unidade (D-194) · 10 blocos · estende v2 com:
...
*Documento vivo · mantido pelo Arquiteto · atualizado em kit D-033 sempre que P-VN consolidar termos novos cross-visão.*
